...
export const  ConfirmationModal = ({ requestAction, color, label }) => {
    ...
    return (
        <div>
            ...
            {color === "green" && <EditButton label={label} openModal={openModal} />}
            {color === "rose" && <DeleteButton label={label} openModal={openModal} />}
                    ...
                    <div className="relative p-4 w-full max-w-md max-h-full">
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="p-4 md:p-5 text-center">
                                ...
                                <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to {color === 'green' ? 'Edit' : 'Delete'}?</h3>
                                <button
...
function EditButton({ label, openModal }) {
    return (
        <button
            onClick={openModal}
...
function DeleteButton({ label, openModal }) {
    return (
        <button
            onClick={openModal}
